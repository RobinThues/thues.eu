	...
	<div class="eleven wide column">
		<div id="content" class="ui very padded raised green segment">
			...
			if (strpos($url, "/de/") !== false) { 
				...
				After school I started studying computer science at <a href="http://www.uni-duesseldorf.de/home/startseite.html">Heinrich-Heine-University</a> and I am planning on doing my Master of Science there. My focus is on network technologies.<br>
